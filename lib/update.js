...
const contest_id = 130289
// onlineUpdate(contest_id, 1, 'DUEL!!')
const schedule_130289 = (uuid) => {
    return { schedule: 1, remark: 'DUEL!!' }
}
analyzeGameRecordFromFiles(contest_id, schedule_130289)
...
// console.log(res)
// const { basic, result } = decodeGameRecord(decoder, load_json_record(130289, '240918-876d3dfa-187a-4742-b2f1-2c88e7833375'))
