...
const analyzeGameRecord = async (conn, contest_id, game_uuid, schedule, remark) => {
...
// console.log(res)
// const { basic, result } = decodeGameRecord(decoder, load_json_record(253826, '240812-cb3767a4-5d4b-496c-877f-7b46de05c527'))
